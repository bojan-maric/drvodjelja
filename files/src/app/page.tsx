    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[90vh] min-h-[600px] flex items-center justify-center">
        ...
        <div className="absolute inset-0">
          <Image
            src="/images/hero/drvo_full.webp"
            alt="Drvodjelja - stolarska radionica"
            fill
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="#radovi" 
              className="btn bg-wood text-white hover:bg-wood-dark text-lg px-8 py-3 rounded-lg transition-colors"
            >
              Pogledaj radove
            </a>
            <a 
              href="#kontakt" 
              className="btn bg-white/10 text-white border-2 border-white/50 hover:bg-white hover:text-wood-darker px-8 py-3 rounded-lg transition-all"
            >
              Kontaktirajte nas
            </a>
          </div>
